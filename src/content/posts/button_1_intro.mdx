...
<img
   src="/src/assets/images/button/intro/friends-talking.jpg"
...
Alright, maybe this intro story to [embedded system](todo.com) [rust programming](todo.com) is a little too
...
<img
   src="/src/assets/images/button/intro/trash-pickup.png"
   alt="cool relevant image"
   class="w-2/3 mx-auto border border-2 border-accentColor"
/>
...
<img
   src="/src/assets/images/button/intro/button-cartoon.jpg"
   alt="cool relevant image"
   class="w-2/3 mx-auto border border-2 border-accentColor"
/>
...
be the worst idea to overview the follwowing topics. 
...
- GitHub Actions (is there some way to auto update?)
