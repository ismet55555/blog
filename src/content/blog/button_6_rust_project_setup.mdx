---
title: 'Big Button - Part 6 - Rust Project Setup'
...
nextPost: 
  slug: "button_7_rust_project_configuration"
...
Here we will be creating a new and general Rust project using the `cargo`
