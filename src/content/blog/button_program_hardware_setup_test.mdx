...
<Tag color="green" txt="💻 HACKER" /> We are going to install all software needed to start interacting with our Raspberry Pi Pico 2 W
...
5. Raspberry Pi Pico 2 W Microcontroller
...
Pi Pico 2 W, we are just checking if we can talk to the debug probe.
