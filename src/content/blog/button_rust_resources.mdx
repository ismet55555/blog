---
title: 'Big Button - Part 6 - Rust Programming Resources'
...
<Aside variant="tip">
  Don't get sucked into the Rust information black hole or tutorial hell.
  **Keep moving, apply, build!**
</Aside>
...
| Rust Embedded Drivers (RED) Book | A practical guide to creating hardware drivers that integrate with the embedded Rust ecosystem. | [Link](https://red.implrust.com/) |
