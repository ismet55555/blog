...
<Aside variant="tip">
  ...
  each developer may have his/her preferences, seetings, and so on. Being relatively new to Rust 
...
```log frame="none"
[DEBUG ] main.rs:22    : A debug level logging message
[INFO  ] main.rs:25    : This is a simple info level log message
[ERROR ] main.rs:22    : This message has a variable: 3
```
