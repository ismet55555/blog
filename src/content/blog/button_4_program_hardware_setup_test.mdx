---
title: 'Big Button - Part 4 - Programming Hardware Setup and Test'
...
{/*
TODO: Run it by cloude for feedback
*/}
...
To check if rust is already installed. Open up your computer [terminal](TODO) and enter the following
...
rules for our debug probe seperately. **udev rules** are instructions that tell Linux what to do when specific devices
...
If you see such and output, *great!* You are done with this section. 
