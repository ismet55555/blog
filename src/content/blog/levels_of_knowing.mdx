...
I've always wondered about how interesting and mysterious it is to really know about
something and be comfortable with it. Specifically, how does someone get introduced
...
to the complete knowledge of it. 

Let me ask you - What is it like to be a plumber in Japan? Or how exactly do
you become a brain surgeon in the US. To what actual and practical detail can
...
And how would you know it within the concept of your own world view and your
own abilities?

## Defining Knowledge

In the scope of this essay, *knowledge* can be the information about a thing or some way of doing some thing.
It can also be the comfort of knowing or doing some thing. That is, the content and details
may be irrelevant, while the vision, feeling, and confidence is what is important.

For example, given that you were able to successfully get into a healthy shape two years ago, you are confident
and comfortable knowing that you can do it again. If needed, you could recall or get to important details
and information.

Also, when I write knowing *"a thing"*, this could mean a physical thing, a concept,
an idea, a believe, a place, a technique, and so on. I am not talking
about your "knowledge" of innate abilities like walking, talking, or breathing.
Maybe, as an exercise, think about something that you yourself have learned well
and how exactly you initially become familiar with it.
...
Let's outline the knowledge extremes here: 

On one side, you absolutely do not even know the thing/concept/place exists.
It's invisible and unimaginable on any possible level
(example: How do I start form a company in Estonia).

On the other extreme, you absolutely know everything there is to know about
the thing/concept/place.
(i.e. How do I file that claim at your company where you worked the past 20 years).

In reality, this spectrum is more open ended on the latter/right side - a one-sided spectrum.
That is, you defiantly can completely not know something and not know
it even exists. However, the level of detail and insight you can get from something
already familiar is infinite (i.e. Re-reading a textbook for the forth time).
...
As an analogy, you might think about examining a physical object. At one
...
this one-sided knowledge spectrum that I have observed and seem to be
a good measure.

## Levels of Knowing

When I think about where our acquired knowledge and competence fundamentally comes from,
I think there seem to be very distinct levels of discovering and knowing something.
...
0. **You do not know the thing or anything about it.
   ...
   *Possible example: Knowing the avalanche method to pay off a dept*

1. **You know about it or have heard of it. You have the info. You can google it.
   You do not know anyone personally that actually does the thing or is the thing.**

   *Possible example: Seeing some YouTuber that is bow hunting elk in Colorado*

2. **You know someone that knows/does/is the thing or is the thing, but they are not close to you.
...
3. **The community you are part of naturally knows/does/is the thing.
   ...
   *Possible example: Being a Bosnian woman preparing a baklava desert for the end of Ramadan.*

4. **You have someone very close to you that knows/does/is the thing.
   You know how this person thinks, makes decision, or their abilities.
   ...
   *Possible example: Your present father is a injury lawyer*

5. **You yourself know/do/are the thing. You have first-hand
   and deep experience. You know what is and what is not possible.**

   *Possible example: You have personally rebuild an car engine*
...
Given the proposed levels of knowing, the question naturally arises:
How do we transverse knowledge levels 

### Luck / Chaos / Random / Accident
...
a point of diminishing return of effort. 
